export function notEmpty<TVlaue>(value: TVlaue | null | undefined): value is TVlaue {
...
export const PUBLIC_NODES: Record<number, string[] | readonly string[]> = {
    ...
    [mainnet.id]: ['https://ethereum.publicnode.com', 'https://eth.llamarpc.com', 'https://cloudflare-eth.com'].filter(
        notEmpty,
    ),
